...
class TestRestoreUNet:
    ...
    @pytest.fixture
    def model(self):
        from faunacodec.restoration._network import RestoreUNet
        return RestoreUNet(
            base_channels=16,
...
class TestTemporalAttention:
    ...
    def test_shape_preserved(self):
        ...
        from faunacodec.restoration._blocks import TemporalAttention
...
class TestRestorer:
    ...
    def restorer_and_cfg(self, tmp_path):
        ...
        from faunacodec.restoration.restorer import Restorer
    ...
    def test_restore_frames_wrapper(self, tmp_path):
        ...
        from faunacodec.restoration.restore import restore_frames
