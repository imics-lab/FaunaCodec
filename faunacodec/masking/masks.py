...
def build_frame_mask(
    *,
    ...
    if src == "frame_drop_roi_box":
        ...
        box_by_frame = frame_drop_json.get("roi_box_by_frame", {}) or {}
        if isinstance(box_by_frame, dict) and frame_key in box_by_frame:
            pf = {"roi_box": box_by_frame[frame_key]}
        else:
            # Backward compatibility with archive versions 1 and 2.
            pf = (frame_drop_json.get("per_frame", {}) or {}).get(frame_key, {}) or {}
