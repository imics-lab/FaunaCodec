...
class Restorer:
    ...
    def restore_sequence(self, degraded_frames: list[np.ndarray]) -> list[np.ndarray]:
        ...
        restored: list[torch.Tensor | None] = [None] * N
